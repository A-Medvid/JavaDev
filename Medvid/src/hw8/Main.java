...
import hw8.course1.Course;
import hw8.course1.lessons.Lecture;
import hw8.course1.lessons.ServiceLess;
import hw8.course1.students.Student;
import hw8.course1.teachers.Teacher;
...
public class Main {
    public static void main(String[] args) {
        ...
        if (course.id != 0 && lecture.courseId != 0 && student.courseId != 0 && teacher.courseId != 0) {
            while (counterLecture <= 8) {
        ...
        System.out.println("You`ve created 8 lectures.");
        System.out.println("Total amount of lectures is " + counterLecture + ".");
    }
}
